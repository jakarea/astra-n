...
import { getDashboardCache, setDashboardCache } from '@/lib/cache-manager'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const { getUserDataCache, setUserDataCache } = await import('@/lib/cache-manager')
    let userData = getUserDataCache(user.id)
